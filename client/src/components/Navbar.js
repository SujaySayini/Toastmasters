            ...
            <nav className = "navbar align-left navbar-dark" style={{background: 'linear-gradient(rgb(119, 36, 50), rgb(119, 36, 50) 30%, rgb(76, 23, 32))'}} >
                ...
                <div className = "collapse navbar-collapse" id="navbarNav">
                    <ul className = "navbar-nav">
                        ...
                        <li className="dropdown nav-item" style={{textAlign: 'left', paddingLeft: '2em', marginBottom: '0'}}>
                            {user.userLevel === 'Eboard'? <a className="dropdown-toggle nav-link " data-bs-toggle="dropdown" data-bs-target='dropdown-menu' href="#">Officer Tools<span className="caret"></span></a>
                            :
                        ...
                        <li className="dropdown nav-item" style={{textAlign: 'left', paddingLeft: '2em', marginBottom: '0'}}>
                            {user.userLevel === 'Admin' ? <a className="dropdown-toggle nav-link " data-bs-toggle="dropdown" data-bs-target='dropdown-menu' href="#">Admin Tools<span className="caret"></span></a>
                            :
                            <a className="dropdown-toggle disabled nav-link " data-bs-toggle="dropdown" data-bs-target='dropdown-menu' href="#">Admin Tools<span className="caret"></span></a>
                            }<ul className="dropdown-menu bg-dark" style={{marginTop: '0', paddingTop: '0'}}>
                                <li className = "nav-item" >
                                    <a className = "nav-link" href = "#" data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show" style={{textAlign: 'left', paddingLeft: '2em'}} onClick={() =>{props.swap('Admin')}}>Admin Home</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
